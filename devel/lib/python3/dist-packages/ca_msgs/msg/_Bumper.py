...
"""
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.is_left_pressed, _x.is_right_pressed, _x.is_light_left, _x.is_light_front_left, _x.is_light_center_left, _x.is_light_center_right, _x.is_light_front_right, _x.is_light_right, _x.light_signal_left, _x.light_signal_front_left, _x.light_signal_center_left, _x.light_signal_center_right, _x.light_signal_front_right, _x.light_signal_right,) = _get_struct_8B6H().unpack(str[start:end])
...
def _get_struct_I():
    ...
    return _struct_I
_struct_8B6H = None
def _get_struct_8B6H():
    global _struct_8B6H
    if _struct_8B6H is None:
