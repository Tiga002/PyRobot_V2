...
struct AlvarMarker_
{
  ...
  _pose_type pose;
   ...
   typedef  ::geometry_msgs::PoseStamped_<ContainerAllocator>  _pose_img_0_type;
  _pose_img_0_type pose_img_0;

   typedef  ::geometry_msgs::PoseStamped_<ContainerAllocator>  _pose_img_1_type;
  _pose_img_1_type pose_img_1;

   typedef  ::geometry_msgs::PoseStamped_<ContainerAllocator>  _pose_img_2_type;
  _pose_img_2_type pose_img_2;

   typedef  ::geometry_msgs::PoseStamped_<ContainerAllocator>  _pose_img_3_type;
  _pose_img_3_type pose_img_3;
...
// {'ar_track_alvar_msgs': ['/home/developer/low_cost_ws/src/pyrobot/robots/LoCoBot/thirdparty/ar_track_alvar/ar_track_alvar_msgs/msg'], 'std_msgs': ['/opt/ros/kinetic/share/std_msgs/cmake/../msg'], 'geometry_msgs': ['/opt/ros/kinetic/share/geometry_msgs/cmake/../msg']}
...
struct MD5Sum< ::ar_track_alvar_msgs::AlvarMarker_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0x2cb98ba212070cd8ULL;
  static const uint64_t static_value2 = 0xfe95c2bdafca0cacULL;
};
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::ar_track_alvar_msgs::AlvarMarker_<ContainerAllocator> >
  {
    template<typename Stream, typename T> inline static void allInOne(Stream& stream, T m)
    {
      ...
      stream.next(m.pose);
      stream.next(m.pose_img_0);
      stream.next(m.pose_img_1);
      stream.next(m.pose_img_2);
      stream.next(m.pose_img_3);
    }
...
struct Printer< ::ar_track_alvar_msgs::AlvarMarker_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::ar_track_alvar_msgs::AlvarMarker_<ContainerAllocator>& v)
  {
    ...
    s << indent << "pose_img_0: ";
    s << std::endl;
    Printer< ::geometry_msgs::PoseStamped_<ContainerAllocator> >::stream(s, indent + "  ", v.pose_img_0);
    s << indent << "pose_img_1: ";
    s << std::endl;
    Printer< ::geometry_msgs::PoseStamped_<ContainerAllocator> >::stream(s, indent + "  ", v.pose_img_1);
    s << indent << "pose_img_2: ";
    s << std::endl;
    Printer< ::geometry_msgs::PoseStamped_<ContainerAllocator> >::stream(s, indent + "  ", v.pose_img_2);
    s << indent << "pose_img_3: ";
    s << std::endl;
    Printer< ::geometry_msgs::PoseStamped_<ContainerAllocator> >::stream(s, indent + "  ", v.pose_img_3);
  }
};
