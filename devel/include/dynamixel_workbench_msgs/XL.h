// Generated by gencpp from file dynamixel_workbench_msgs/XL.msg
// DO NOT EDIT!


#ifndef DYNAMIXEL_WORKBENCH_MSGS_MESSAGE_XL_H
#define DYNAMIXEL_WORKBENCH_MSGS_MESSAGE_XL_H
...
struct XL_
{
  typedef XL_<ContainerAllocator> Type;
  ...
  XL_(const ContainerAllocator& _alloc)
    : Model_Number(0)
    , Firmware_Version(0)
    , ID(0)
    , Baud_Rate(0)
  ...
  typedef boost::shared_ptr< ::dynamixel_workbench_msgs::XL_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::dynamixel_workbench_msgs::XL_<ContainerAllocator> const> ConstPtr;

}; // struct XL_

typedef ::dynamixel_workbench_msgs::XL_<std::allocator<void> > XL;

typedef boost::shared_ptr< ::dynamixel_workbench_msgs::XL > XLPtr;
typedef boost::shared_ptr< ::dynamixel_workbench_msgs::XL const> XLConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::dynamixel_workbench_msgs::XL_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::dynamixel_workbench_msgs::XL_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::dynamixel_workbench_msgs::XL_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::dynamixel_workbench_msgs::XL_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::dynamixel_workbench_msgs::XL_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::dynamixel_workbench_msgs::XL_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::dynamixel_workbench_msgs::XL_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::dynamixel_workbench_msgs::XL_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::dynamixel_workbench_msgs::XL_<ContainerAllocator> >
{
  ...
  static const char* value(const ::dynamixel_workbench_msgs::XL_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xea49a2701ed85afcULL;
  static const uint64_t static_value2 = 0x888c2c84aca6af1fULL;
};

template<class ContainerAllocator>
struct DataType< ::dynamixel_workbench_msgs::XL_<ContainerAllocator> >
{
  static const char* value()
  {
    return "dynamixel_workbench_msgs/XL";
  }
...
template<class ContainerAllocator>
struct Definition< ::dynamixel_workbench_msgs::XL_<ContainerAllocator> >
{
  static const char* value()
  {
    return "# This message is compatible with control table of Dynamixel XL Series (XL430-W250)\n\
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::dynamixel_workbench_msgs::XL_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::dynamixel_workbench_msgs::XL_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::dynamixel_workbench_msgs::XL_<ContainerAllocator>& v)
  {
...
#endif // DYNAMIXEL_WORKBENCH_MSGS_MESSAGE_XL_H
