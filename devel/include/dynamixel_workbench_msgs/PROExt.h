// Generated by gencpp from file dynamixel_workbench_msgs/PROExt.msg
// DO NOT EDIT!


#ifndef DYNAMIXEL_WORKBENCH_MSGS_MESSAGE_PROEXT_H
#define DYNAMIXEL_WORKBENCH_MSGS_MESSAGE_PROEXT_H
...
struct PROExt_
{
  typedef PROExt_<ContainerAllocator> Type;
  ...
  PROExt_(const ContainerAllocator& _alloc)
    : Model_Number(0)
    , Firmware_Version(0)
    , ID(0)
    , Baud_Rate(0)
  ...
  typedef boost::shared_ptr< ::dynamixel_workbench_msgs::PROExt_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::dynamixel_workbench_msgs::PROExt_<ContainerAllocator> const> ConstPtr;

}; // struct PROExt_

typedef ::dynamixel_workbench_msgs::PROExt_<std::allocator<void> > PROExt;

typedef boost::shared_ptr< ::dynamixel_workbench_msgs::PROExt > PROExtPtr;
typedef boost::shared_ptr< ::dynamixel_workbench_msgs::PROExt const> PROExtConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::dynamixel_workbench_msgs::PROExt_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::dynamixel_workbench_msgs::PROExt_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
// {'std_msgs': ['/opt/ros/kinetic/share/std_msgs/cmake/../msg'], 'dynamixel_workbench_msgs': ['/home/developer/low_cost_ws/src/pyrobot/robots/LoCoBot/thirdparty/dynamixel-workbench-msgs/dynamixel_workbench_msgs/msg']}
...
template <class ContainerAllocator>
struct IsFixedSize< ::dynamixel_workbench_msgs::PROExt_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::dynamixel_workbench_msgs::PROExt_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::dynamixel_workbench_msgs::PROExt_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::dynamixel_workbench_msgs::PROExt_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::dynamixel_workbench_msgs::PROExt_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::dynamixel_workbench_msgs::PROExt_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::dynamixel_workbench_msgs::PROExt_<ContainerAllocator> >
{
  static const char* value()
  {
    return "7e5c32f4e1d1adb95d72d66d5dcec77e";
  }

  static const char* value(const ::dynamixel_workbench_msgs::PROExt_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x7e5c32f4e1d1adb9ULL;
  static const uint64_t static_value2 = 0x5d72d66d5dcec77eULL;
};

template<class ContainerAllocator>
struct DataType< ::dynamixel_workbench_msgs::PROExt_<ContainerAllocator> >
{
  static const char* value()
  {
    return "dynamixel_workbench_msgs/PROExt";
  }
...
template<class ContainerAllocator>
struct Definition< ::dynamixel_workbench_msgs::PROExt_<ContainerAllocator> >
{
  static const char* value()
  {
    return "# This message is compatible with control table of Dynamixel PRO Series\n\
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::dynamixel_workbench_msgs::PROExt_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::dynamixel_workbench_msgs::PROExt_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::dynamixel_workbench_msgs::PROExt_<ContainerAllocator>& v)
  {
...
#endif // DYNAMIXEL_WORKBENCH_MSGS_MESSAGE_PROEXT_H
