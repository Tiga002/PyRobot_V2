// Generated by gencpp from file dynamixel_workbench_msgs/XMExt.msg
// DO NOT EDIT!


#ifndef DYNAMIXEL_WORKBENCH_MSGS_MESSAGE_XMEXT_H
#define DYNAMIXEL_WORKBENCH_MSGS_MESSAGE_XMEXT_H
...
struct XMExt_
{
  typedef XMExt_<ContainerAllocator> Type;
  ...
  XMExt_(const ContainerAllocator& _alloc)
    : Model_Number(0)
    , Firmware_Version(0)
    , ID(0)
    , Baud_Rate(0)
  ...
  typedef boost::shared_ptr< ::dynamixel_workbench_msgs::XMExt_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::dynamixel_workbench_msgs::XMExt_<ContainerAllocator> const> ConstPtr;

}; // struct XMExt_

typedef ::dynamixel_workbench_msgs::XMExt_<std::allocator<void> > XMExt;

typedef boost::shared_ptr< ::dynamixel_workbench_msgs::XMExt > XMExtPtr;
typedef boost::shared_ptr< ::dynamixel_workbench_msgs::XMExt const> XMExtConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::dynamixel_workbench_msgs::XMExt_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::dynamixel_workbench_msgs::XMExt_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::dynamixel_workbench_msgs::XMExt_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::dynamixel_workbench_msgs::XMExt_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::dynamixel_workbench_msgs::XMExt_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::dynamixel_workbench_msgs::XMExt_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::dynamixel_workbench_msgs::XMExt_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::dynamixel_workbench_msgs::XMExt_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::dynamixel_workbench_msgs::XMExt_<ContainerAllocator> >
{
  static const char* value()
  {
    return "e948e1a6eb756e0186bd427184b72341";
  }

  static const char* value(const ::dynamixel_workbench_msgs::XMExt_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xe948e1a6eb756e01ULL;
  static const uint64_t static_value2 = 0x86bd427184b72341ULL;
};

template<class ContainerAllocator>
struct DataType< ::dynamixel_workbench_msgs::XMExt_<ContainerAllocator> >
{
  static const char* value()
  {
    return "dynamixel_workbench_msgs/XMExt";
  }
...
template<class ContainerAllocator>
struct Definition< ::dynamixel_workbench_msgs::XMExt_<ContainerAllocator> >
{
  static const char* value()
  {
    return "# This message is compatible with control table of Dynamixel XM Series (XM540-W150, XM540-W270)\n\
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::dynamixel_workbench_msgs::XMExt_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::dynamixel_workbench_msgs::XMExt_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::dynamixel_workbench_msgs::XMExt_<ContainerAllocator>& v)
  {
...
#endif // DYNAMIXEL_WORKBENCH_MSGS_MESSAGE_XMEXT_H
