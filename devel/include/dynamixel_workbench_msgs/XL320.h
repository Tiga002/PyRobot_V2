// Generated by gencpp from file dynamixel_workbench_msgs/XL320.msg
// DO NOT EDIT!


#ifndef DYNAMIXEL_WORKBENCH_MSGS_MESSAGE_XL320_H
#define DYNAMIXEL_WORKBENCH_MSGS_MESSAGE_XL320_H
...
struct XL320_
{
  ...
  typedef boost::shared_ptr< ::dynamixel_workbench_msgs::XL320_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::dynamixel_workbench_msgs::XL320_<ContainerAllocator> const> ConstPtr;

}; // struct XL320_

typedef ::dynamixel_workbench_msgs::XL320_<std::allocator<void> > XL320;

typedef boost::shared_ptr< ::dynamixel_workbench_msgs::XL320 > XL320Ptr;
typedef boost::shared_ptr< ::dynamixel_workbench_msgs::XL320 const> XL320ConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::dynamixel_workbench_msgs::XL320_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::dynamixel_workbench_msgs::XL320_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::dynamixel_workbench_msgs::XL320_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::dynamixel_workbench_msgs::XL320_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::dynamixel_workbench_msgs::XL320_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::dynamixel_workbench_msgs::XL320_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::dynamixel_workbench_msgs::XL320_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::dynamixel_workbench_msgs::XL320_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::dynamixel_workbench_msgs::XL320_<ContainerAllocator> >
{
  ...
  static const char* value(const ::dynamixel_workbench_msgs::XL320_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xf4c9a1069d9176eaULL;
  static const uint64_t static_value2 = 0xf1948e4f20082d40ULL;
};

template<class ContainerAllocator>
struct DataType< ::dynamixel_workbench_msgs::XL320_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::dynamixel_workbench_msgs::XL320_<ContainerAllocator> >
{
  static const char* value()
  {
    return "# This message is compatible with control table of Dynamixel XL Series (XL320)\n\
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::dynamixel_workbench_msgs::XL320_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::dynamixel_workbench_msgs::XL320_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::dynamixel_workbench_msgs::XL320_<ContainerAllocator>& v)
  {
...
#endif // DYNAMIXEL_WORKBENCH_MSGS_MESSAGE_XL320_H
