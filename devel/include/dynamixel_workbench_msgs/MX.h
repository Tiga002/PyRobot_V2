...
struct MD5Sum< ::dynamixel_workbench_msgs::MX_<ContainerAllocator> >
{
  ...
  {
    return "f2b95d725db95aec0be4e30a981f545e";
  }

  static const char* value(const ::dynamixel_workbench_msgs::MX_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xf2b95d725db95aecULL;
  static const uint64_t static_value2 = 0x0be4e30a981f545eULL;
};
...
struct Definition< ::dynamixel_workbench_msgs::MX_<ContainerAllocator> >
{
  static const char* value()
  {
    return "# This message is compatible with control table of Dynamixel MX Series (MX-12W, MX-28T/MX-28R/MX-28AT/MX-28AR)\n\
