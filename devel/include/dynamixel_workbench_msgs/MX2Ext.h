// Generated by gencpp from file dynamixel_workbench_msgs/MX2Ext.msg
// DO NOT EDIT!


#ifndef DYNAMIXEL_WORKBENCH_MSGS_MESSAGE_MX2EXT_H
#define DYNAMIXEL_WORKBENCH_MSGS_MESSAGE_MX2EXT_H
...
struct MX2Ext_
{
  typedef MX2Ext_<ContainerAllocator> Type;
  ...
  MX2Ext_(const ContainerAllocator& _alloc)
    : Model_Number(0)
    , Firmware_Version(0)
    , ID(0)
    , Baud_Rate(0)
  ...
  typedef boost::shared_ptr< ::dynamixel_workbench_msgs::MX2Ext_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::dynamixel_workbench_msgs::MX2Ext_<ContainerAllocator> const> ConstPtr;

}; // struct MX2Ext_

typedef ::dynamixel_workbench_msgs::MX2Ext_<std::allocator<void> > MX2Ext;

typedef boost::shared_ptr< ::dynamixel_workbench_msgs::MX2Ext > MX2ExtPtr;
typedef boost::shared_ptr< ::dynamixel_workbench_msgs::MX2Ext const> MX2ExtConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::dynamixel_workbench_msgs::MX2Ext_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::dynamixel_workbench_msgs::MX2Ext_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
// {'dynamixel_workbench_msgs': ['/home/developer/low_cost_ws/src/pyrobot/robots/LoCoBot/thirdparty/dynamixel-workbench-msgs/dynamixel_workbench_msgs/msg'], 'std_msgs': ['/opt/ros/kinetic/share/std_msgs/cmake/../msg']}
...
template <class ContainerAllocator>
struct IsMessage< ::dynamixel_workbench_msgs::MX2Ext_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::dynamixel_workbench_msgs::MX2Ext_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::dynamixel_workbench_msgs::MX2Ext_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::dynamixel_workbench_msgs::MX2Ext_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::dynamixel_workbench_msgs::MX2Ext_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::dynamixel_workbench_msgs::MX2Ext_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::dynamixel_workbench_msgs::MX2Ext_<ContainerAllocator> >
{
  ...
  static const char* value(const ::dynamixel_workbench_msgs::MX2Ext_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xe5260697f25a6834ULL;
  static const uint64_t static_value2 = 0xd84f685c2f474e33ULL;
};

template<class ContainerAllocator>
struct DataType< ::dynamixel_workbench_msgs::MX2Ext_<ContainerAllocator> >
{
  static const char* value()
  {
    return "dynamixel_workbench_msgs/MX2Ext";
  }
...
template<class ContainerAllocator>
struct Definition< ::dynamixel_workbench_msgs::MX2Ext_<ContainerAllocator> >
{
  static const char* value()
  {
    return "# This message is compatible with control table of Dynamixel MX(2.0) Series (MX-64T/MX64-R/MX-64AT/MX-64AR(2.0), MX-106T/MX-106R(2.0))\n\
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::dynamixel_workbench_msgs::MX2Ext_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::dynamixel_workbench_msgs::MX2Ext_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::dynamixel_workbench_msgs::MX2Ext_<ContainerAllocator>& v)
  {
...
#endif // DYNAMIXEL_WORKBENCH_MSGS_MESSAGE_MX2EXT_H
