...
if("TRUE" STREQUAL "TRUE")
  set(ca_msgs_SOURCE_PREFIX /home/developer/low_cost_ws/src/pyrobot/robots/LoCoBot/thirdparty/create_autonomy/ca_msgs)
  set(ca_msgs_DEVEL_PREFIX /home/developer/low_cost_ws/devel)
  set(ca_msgs_INSTALL_PREFIX "")
  set(ca_msgs_PREFIX ${ca_msgs_DEVEL_PREFIX})
else()
  set(ca_msgs_SOURCE_PREFIX "")
  set(ca_msgs_DEVEL_PREFIX "")
  set(ca_msgs_INSTALL_PREFIX /home/developer/low_cost_ws/install)
...
if(NOT "/home/developer/low_cost_ws/devel/include " STREQUAL " ")
  ...
  elseif(NOT "http://wiki.ros.org/ca_msgs " STREQUAL " ")
    set(_report "Check the website 'http://wiki.ros.org/ca_msgs' for information and consider reporting the problem.")
  else()
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'ca_msgs' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'ca_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/developer/low_cost_ws/src/pyrobot/robots/LoCoBot/thirdparty/create_autonomy/ca_msgs/${idir}'.  ${_report}")
    endif()
...
set(ca_msgs_EXPORTED_TARGETS "ca_msgs_generate_messages_cpp;ca_msgs_generate_messages_eus;ca_msgs_generate_messages_lisp;ca_msgs_generate_messages_nodejs;ca_msgs_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${ca_msgs_dep}_FOUND)
      find_package(${ca_msgs_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${ca_msgs_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
