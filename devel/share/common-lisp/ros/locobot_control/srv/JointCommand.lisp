...
(cl:in-package locobot_control-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <JointCommand-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'JointCommand-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name locobot_control-srv:<JointCommand-request> is deprecated: use locobot_control-srv:JointCommand-request instead.")))

(cl:ensure-generic-function 'unit-val :lambda-list '(m))
(cl:defmethod unit-val ((m <JointCommand-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader locobot_control-srv:unit-val is deprecated.  Use locobot_control-srv:unit instead.")
  (unit m))

(cl:ensure-generic-function 'id-val :lambda-list '(m))
(cl:defmethod id-val ((m <JointCommand-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader locobot_control-srv:id-val is deprecated.  Use locobot_control-srv:id instead.")
  (id m))

(cl:ensure-generic-function 'goal_position-val :lambda-list '(m))
(cl:defmethod goal_position-val ((m <JointCommand-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader locobot_control-srv:goal_position-val is deprecated.  Use locobot_control-srv:goal_position instead.")
  (goal_position m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<JointCommand-request>)))
  ...
  "locobot_control/JointCommandRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'JointCommand-request)))
  "Returns string type for a service object of type 'JointCommand-request"
  "locobot_control/JointCommandRequest")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<JointCommand-request>)))
  ...
  (cl:format cl:nil "~%~%string unit~%uint8 id~%float32 goal_position~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'JointCommand-request)))
  "Returns full string definition for message of type 'JointCommand-request"
  (cl:format cl:nil "~%~%string unit~%uint8 id~%float32 goal_position~%~%~%"))
...
(cl:defmethod cl:initialize-instance :after ((m <JointCommand-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'JointCommand-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name locobot_control-srv:<JointCommand-response> is deprecated: use locobot_control-srv:JointCommand-response instead.")))

(cl:ensure-generic-function 'result-val :lambda-list '(m))
(cl:defmethod result-val ((m <JointCommand-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader locobot_control-srv:result-val is deprecated.  Use locobot_control-srv:result instead.")
  (result m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<JointCommand-response>)))
  ...
  "locobot_control/JointCommandResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'JointCommand-response)))
  "Returns string type for a service object of type 'JointCommand-response"
  "locobot_control/JointCommandResponse")
