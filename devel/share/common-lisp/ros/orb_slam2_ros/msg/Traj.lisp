...
(cl:defmethod cl:initialize-instance :after ((m <Traj>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Traj)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name orb_slam2_ros-msg:<Traj> is deprecated: use orb_slam2_ros-msg:Traj instead.")))
...
(cl:defmethod poses-val ((m <Traj>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader orb_slam2_ros-msg:poses-val is deprecated.  Use orb_slam2_ros-msg:poses instead.")
  (poses m))

(cl:ensure-generic-function 'mnIds-val :lambda-list '(m))
(cl:defmethod mnIds-val ((m <Traj>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader orb_slam2_ros-msg:mnIds-val is deprecated.  Use orb_slam2_ros-msg:mnIds instead.")
  (mnIds m))
