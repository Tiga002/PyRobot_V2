...
(cl:ensure-generic-function 'pose_img_0-val :lambda-list '(m))
(cl:defmethod pose_img_0-val ((m <AlvarMarker>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ar_track_alvar_msgs-msg:pose_img_0-val is deprecated.  Use ar_track_alvar_msgs-msg:pose_img_0 instead.")
  (pose_img_0 m))

(cl:ensure-generic-function 'pose_img_1-val :lambda-list '(m))
(cl:defmethod pose_img_1-val ((m <AlvarMarker>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ar_track_alvar_msgs-msg:pose_img_1-val is deprecated.  Use ar_track_alvar_msgs-msg:pose_img_1 instead.")
  (pose_img_1 m))

(cl:ensure-generic-function 'pose_img_2-val :lambda-list '(m))
(cl:defmethod pose_img_2-val ((m <AlvarMarker>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ar_track_alvar_msgs-msg:pose_img_2-val is deprecated.  Use ar_track_alvar_msgs-msg:pose_img_2 instead.")
  (pose_img_2 m))

(cl:ensure-generic-function 'pose_img_3-val :lambda-list '(m))
(cl:defmethod pose_img_3-val ((m <AlvarMarker>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ar_track_alvar_msgs-msg:pose_img_3-val is deprecated.  Use ar_track_alvar_msgs-msg:pose_img_3 instead.")
  (pose_img_3 m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <AlvarMarker>) ostream)
  ...
  (roslisp-msg-protocol:serialize (cl:slot-value msg 'pose_img_0) ostream)
  (roslisp-msg-protocol:serialize (cl:slot-value msg 'pose_img_1) ostream)
  (roslisp-msg-protocol:serialize (cl:slot-value msg 'pose_img_2) ostream)
  (roslisp-msg-protocol:serialize (cl:slot-value msg 'pose_img_3) ostream)
)
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <AlvarMarker>) istream)
  ...
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'pose_img_0) istream)
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'pose_img_1) istream)
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'pose_img_2) istream)
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'pose_img_3) istream)
  msg
)
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<AlvarMarker>)))
  ...
  "2cb98ba212070cd8fe95c2bdafca0cac")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'AlvarMarker)))
  "Returns md5sum for a message object of type 'AlvarMarker"
  "2cb98ba212070cd8fe95c2bdafca0cac")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<AlvarMarker>)))
  ...
  (cl:format cl:nil "Header header~%uint32 id~%uint32 confidence~%geometry_msgs/PoseStamped pose~%geometry_msgs/PoseStamped pose_img_0~%geometry_msgs/PoseStamped pose_img_1~%geometry_msgs/PoseStamped pose_img_2~%geometry_msgs/PoseStamped pose_img_3~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%================================================================================~%MSG: geometry_msgs/PoseStamped~%# A Pose with reference coordinate frame and timestamp~%Header header~%Pose pose~%~%================================================================================~%MSG: geometry_msgs/Pose~%# A representation of pose in free space, composed of position and orientation. ~%Point position~%Quaternion orientation~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'AlvarMarker)))
  "Returns full string definition for message of type 'AlvarMarker"
  (cl:format cl:nil "Header header~%uint32 id~%uint32 confidence~%geometry_msgs/PoseStamped pose~%geometry_msgs/PoseStamped pose_img_0~%geometry_msgs/PoseStamped pose_img_1~%geometry_msgs/PoseStamped pose_img_2~%geometry_msgs/PoseStamped pose_img_3~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%================================================================================~%MSG: geometry_msgs/PoseStamped~%# A Pose with reference coordinate frame and timestamp~%Header header~%Pose pose~%~%================================================================================~%MSG: geometry_msgs/Pose~%# A representation of pose in free space, composed of position and orientation. ~%Point position~%Quaternion orientation~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <AlvarMarker>))
  (cl:+ 0
     ...
     (roslisp-msg-protocol:serialization-length (cl:slot-value msg 'pose_img_0))
     (roslisp-msg-protocol:serialization-length (cl:slot-value msg 'pose_img_1))
     (roslisp-msg-protocol:serialization-length (cl:slot-value msg 'pose_img_2))
     (roslisp-msg-protocol:serialization-length (cl:slot-value msg 'pose_img_3))
))
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <AlvarMarker>))
  ...
  (cl:list 'AlvarMarker
    ...
    (cl:cons ':pose_img_0 (pose_img_0 msg))
    (cl:cons ':pose_img_1 (pose_img_1 msg))
    (cl:cons ':pose_img_2 (pose_img_2 msg))
    (cl:cons ':pose_img_3 (pose_img_3 msg))
))
