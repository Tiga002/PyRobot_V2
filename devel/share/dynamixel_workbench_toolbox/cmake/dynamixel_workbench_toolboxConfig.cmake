...
if("TRUE" STREQUAL "TRUE")
  set(dynamixel_workbench_toolbox_SOURCE_PREFIX /home/developer/low_cost_ws/src/pyrobot/robots/LoCoBot/thirdparty/dynamixel-workbench/dynamixel_workbench_toolbox)
  set(dynamixel_workbench_toolbox_DEVEL_PREFIX /home/developer/low_cost_ws/devel)
  ...
  set(dynamixel_workbench_toolbox_INSTALL_PREFIX /home/developer/low_cost_ws/install)
...
if(NOT "/home/developer/low_cost_ws/src/pyrobot/robots/LoCoBot/thirdparty/dynamixel-workbench/dynamixel_workbench_toolbox/include " STREQUAL " ")
  set(dynamixel_workbench_toolbox_INCLUDE_DIRS "")
  set(_include_dirs "/home/developer/low_cost_ws/src/pyrobot/robots/LoCoBot/thirdparty/dynamixel-workbench/dynamixel_workbench_toolbox/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'dynamixel_workbench_toolbox' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/developer/low_cost_ws/src/pyrobot/robots/LoCoBot/thirdparty/dynamixel-workbench/dynamixel_workbench_toolbox/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  list(APPEND dynamixel_workbench_toolbox_EXPORTED_TARGETS ${${dynamixel_workbench_toolbox_dep}_EXPORTED_TARGETS})
endforeach()
