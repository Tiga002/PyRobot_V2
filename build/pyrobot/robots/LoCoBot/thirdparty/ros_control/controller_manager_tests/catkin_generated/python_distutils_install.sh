...
echo_and_run cd "/home/developer/low_cost_ws/src/pyrobot/robots/LoCoBot/thirdparty/ros_control/controller_manager_tests"
...
echo_and_run /usr/bin/env \
    ...
    build --build-base "/home/developer/low_cost_ws/build/pyrobot/robots/LoCoBot/thirdparty/ros_control/controller_manager_tests" \
    install \
    $DESTDIR_ARG \
