...
echo_and_run cd "/home/developer/low_cost_ws/src/pyrobot/robots/LoCoBot/thirdparty/ros_control/rqt_controller_manager"
...
echo_and_run /usr/bin/env \
    ...
    build --build-base "/home/developer/low_cost_ws/build/pyrobot/robots/LoCoBot/thirdparty/ros_control/rqt_controller_manager" \
    install \
    $DESTDIR_ARG \
