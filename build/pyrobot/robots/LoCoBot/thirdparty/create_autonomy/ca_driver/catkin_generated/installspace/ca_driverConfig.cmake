...
if(NOT "include;/opt/ros/kinetic/include;/usr/include " STREQUAL " ")
  set(ca_driver_INCLUDE_DIRS "")
  set(_include_dirs "include;/opt/ros/kinetic/include;/usr/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ca_driver' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/developer/low_cost_ws/install/${idir}'.  ${_report}")
    endif()
